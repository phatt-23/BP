...
#include "./reductions/3sat-hcycle.typ"
#include "./reductions/3sat-ssp.typ"
#include "./reductions/3sat-3cg.typ"
#include "./reductions/hcycle-hcircuit.typ"
#include "./reductions/hcircuit-tsp.typ"
