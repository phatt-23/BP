...
export function layoutGraphToCy(cy: cytoscape.Core, graph: GraphInstance, layout: GraphLayout) {
...
export function layoutGraphToCyElements(graph: GraphInstance, layout: GraphLayout): ElementDefinition[] {
...
export function drawConvexHullsFor3DM(cy: cytoscape.Core, graph: GraphInstance) {
    // draw convex hulls
