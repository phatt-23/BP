import { 
    ...
    ParseGraphInputString, 
    type GraphInstance 
} from '../models/GraphInstance';
import { assert } from '../lib';
import { Parse3CNFInstanceString } from '../models/CNF3Instance';
import { 
    FormatSSPToInputString, 
    type SSPInstance 
} from '../models/SSPInstance';
...
function reduceSatToHamCycle(input: string): string {
    ...
    let graph: GraphInstance = { vertices: [], edges: [] };
