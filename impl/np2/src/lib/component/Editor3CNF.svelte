...
<script lang="ts">
    ...
    const comments = [
        ...
        "A variable name is a single word containing only letters (<span>a–z</span>, <span>A–Z</span>), digits (<span>0–9</span>) " +
            "and the symbols <span>_</span>, <span>,</span>, <span>\\</span>, <span>^</span>, <span>(</span>, <span>)</span>, <span>{</span>, <span>}</span>.",
        "The symbol <span>\\</span> must be followed by letters (e.g. <span>\\alpha</span>, <span>\\beta^{\\gamma_5}</span>).",
